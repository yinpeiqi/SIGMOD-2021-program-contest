...
pc_aliases = {
    ...
    "346058u":"3460", "4291":"4290", "4287":"4290", "0622":"0627", "1600":"3435"}
...
pc_single = ["v7582", "15f009wm", "ux31a", "v3772", "v3572", "m731r", "e3111",
             "v3111", "15p030nr", "e5771", "e1731", "2170p", "e1532", "e1522",
             "e1571", "e5571", "15d053cl", "v5573", "8460p", "8570p",
             "2570p", "2760p", "547578", "547150","547375"]
...
def handle_x2(dataset: pd.DataFrame, STATE='Test'):
    ...
    for index, row in dataset.iterrows():
        ...
        if brand == "dell" and pc_name!='0':
            pc['identification'] = pc_name
            solved_spec.append(pc)
        elif pc_name in pc_single:
            pc['identification'] = pc_name
            solved_spec.append(pc)
            ...
            solved_spec.append(pc)
        elif pc_name != '0' and cpu_model != '0' and capacity != '0':
            pc['identification'] = pc_name + ' ' + cpu_model + ' '+ capacity
            solved_spec.append(pc)
        elif pc_name != '0' and cpu_model != '0':
            pc['identification'] = pc_name + ' ' + cpu_model
            solved_spec.append(pc)
        elif pc_name != '0' and cpu_core != '0' and capacity != '0':
